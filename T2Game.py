...
import my_modes
from my_modes import BaseGameMode, ExBlankMode, SkillshotMode, invincibilityMode, shooterMode, ChaseLoopMode, GunMode
...
class T2Game(SkeletonGame):
    ...
    def __init__(self):
        ...
        self.invincibility_mode = invincibilityMode(game=self)
        self.shooter_mode = shooterMode(game=self)
        self.chase_loop_mode = ChaseLoopMode(game=self)
